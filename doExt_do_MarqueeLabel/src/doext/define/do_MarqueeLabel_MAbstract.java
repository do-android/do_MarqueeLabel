...
public abstract class do_MarqueeLabel_MAbstract extends DoUIModule{

	protected do_MarqueeLabel_MAbstract() throws Exception {
		super();
	}
	...
	public void onInit() throws Exception{
        super.onInit();
        //注册属性
		this.registProperty(new DoProperty("direction", PropertyDataType.String, "left", true));
